...
public class HBaseSpatioTemporalStorageDriver {
    ...
    public static int spatioTemporalRangeQuery(SpatialTemporalRangeQueryPredicate predicate, String tableName) {
        ...
        if (tableName.contains("geolife")) {
            myTimestampOidLow = String.format("%d.%s", predicate.getStartTimestamp(), "000");
            myTimestampOidHigh = String.format("%d.%s", predicate.getStopTimestamp(), "999");
        }
