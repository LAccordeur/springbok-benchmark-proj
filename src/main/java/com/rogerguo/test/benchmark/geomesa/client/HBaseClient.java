...
package com.rogerguo.test.benchmark.geomesa.client;
...
public class HBaseClient extends GeoMesaClient {
    ...
    public static void main(String[] args) {
        try {
            ...
            myargs[1] = "172.31.85.41";
            myargs[2] = "--hbase.catalog";
            myargs[3] = "geomesa-porto-benchmark";
            //myargs[3] = "geomesa-porto-mycost";
            String logFilename = "geomesa-ec2-spatiotemporal-6h-01-check.log";
            String queryFilename = "/home/ubuntu/dataset/query-fulldata/porto_fulldata_6h_01.query";
